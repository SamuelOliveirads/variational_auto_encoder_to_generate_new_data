"""variational_auto_encoder_to_generate_new_data file for ensuring the package is executable
as `variational-auto-encoder-to-generate-new-data` and `python -m variational_auto_encoder_to_generate_new_data`
"""
import importlib
